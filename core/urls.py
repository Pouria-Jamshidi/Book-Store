...
from core.views import home, NewBook, NewAuthorView, NewGenreView, book_detail, BookScoreView, NavbarView, home_genre, home_author, download_book, Book_wishlist_cbv
